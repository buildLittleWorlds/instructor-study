...
session-09/                V1 accumulation; V2 contraction; V3 selective expansion; V4 Life sonification
...
- Session 9 - addition reaches a limit; V2 tests subtraction; V3 expands selectively; V4 joins the visual computation and musical encounter into one instrument.
